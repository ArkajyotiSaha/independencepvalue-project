...
We first focus on computing the p-value when the groups are pre-specified. For this purpose, we define two additional functions, that will come in handy later.
